...
from SimpleBaselines.agent.rl_agents.STNStocDQN_RL_Agent import STNStocDQN_RL_Agent
...
class DoubleStocDQN_RL_Agent(STNStocDQN_RL_Agent):
    ...
    def __Double_DQN_bellman_update__(self, old_state: State, action, new_observation : gym.Space, reward: float, terminated, truncated):
        ...
        with torch.no_grad():
            ...
            input_gate = reward_batch + (1 - (terminated_batch | truncated_batch)) * self.gamma * max_q_values
