...
from SimpleBaselines.agent.rl_agents.SthocasticDQN_RL_Agent import SthocasticDQN_RL_Agent
...
class ExperienceReplayStocDQN_RL_Agent(SthocasticDQN_RL_Agent):
    ...
    def __ER_DQN_bellman_update__(self, old_state: State, action, new_observation : gym.Space, reward: float, terminated, truncated):
        ...
        self.QNetwork.update_NN(current_memory, target_value)
