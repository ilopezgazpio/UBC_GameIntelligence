...
# Task 1
# First of all analyze the DFS procedure (SimpleBaselines)
...
Expanded = pd.concat(
    [
       blind_dfs_tree_agent.reporting.log['Expanded'].fillna(0),
       blind_dfs_graph_agent.reporting.log['Expanded'].fillna(0)
    ] , axis=1
)
