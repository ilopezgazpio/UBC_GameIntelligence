...
# Task 1
# First of all analyze the BFS procedure (SimpleBaselines)
...
Expanded = pd.concat(
    [
       blind_bfs_tree_agent.reporting.log['Expanded'].fillna(0),
       blind_bfs_graph_agent.reporting.log['Expanded'].fillna(0)
    ] , axis=1
)
