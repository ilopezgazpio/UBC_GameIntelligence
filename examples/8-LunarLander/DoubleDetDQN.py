...
agent = DoubleDetDQN_RL_Agent(
    ...
    nn_learning_rate = 0.00063, # tasa de aprendizaje
    n_step = 4, # n_step DQN
    egreedy = 0.99, # empieza explorando mucho, 99% de acciones aleatorias
    egreedy_final = 0.1, # acaba casi explotando al 90%
    egreedy_decay = 0.12, # desciende rápido
...
print("Percent of episodes finished successfully: {:.2f}%".format(sum(rewards_total > MIN_MEAN_REWARDS)/num_episodes*100))
