...
from SimpleBaselines.agent.rl_agents.valueIterationLearning_RL_Agent import ValueIterationLearning_RL_Agent
...
for episode in range(num_episodes):
    ...
    rewards_total.append(ValueIteration_agent.final_state.cumulative_reward)
    steps_total.append(ValueIteration_agent.final_state.step + 1)
